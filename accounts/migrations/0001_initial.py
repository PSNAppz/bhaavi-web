...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Product',
            fields=[
                ('id', models.CharField(default=accounts.models.product_gen, editable=False, max_length=255, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice', models.CharField(default=accounts.models.invoice_gen, max_length=255)),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchase', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transaction_details', to='accounts.UserPurchases')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel', models.CharField(default=accounts.models.channel_gen, max_length=255)),
