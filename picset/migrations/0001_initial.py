# Generated by Django 3.0.7 on 2020-07-20 05:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendee_age', models.CharField(blank=True, max_length=3)),
                ...
                ('purchase', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='result_purchase', to='payment.UserPurchases')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('purchase', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='picset_purchase', to='payment.UserPurchases')),
